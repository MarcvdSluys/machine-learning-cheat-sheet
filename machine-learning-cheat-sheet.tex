...
% MvdS:
\usepackage[a4paper, top=2.0cm, left=2.0cm, bottom=2.0cm, right=2.0cm]{geometry}
\usepackage[english]{babel}
\usepackage{pgf, parskip}
\usepackage[font=small, labelfont=bf]{caption}  % Captions in small font, label ("Figure x.y.z:") in boldface
